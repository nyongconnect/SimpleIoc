...
public class DependencyContainerCached extends DependencyContainerInternal {
    ...
    public Collection<ServiceDetails> getImplementations(Class<?> serviceType) {
        ...
        @SuppressLint({"NewApi", "LocalSuppress"}) final Collection<ServiceDetails> implementations = super.getImplementations(serviceType);
    ...
    public Collection<ServiceDetails> getServicesByAnnotation(Class<? extends Annotation> annotationType) {
        ...
        @SuppressLint({"NewApi", "LocalSuppress"}) final Collection<ServiceDetails> servicesByAnnotation = super.getServicesByAnnotation(annotationType);
