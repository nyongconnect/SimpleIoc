...
import com.example.injectorlib.exceptions.AlreadyInitializedException;
...
import com.example.injectorlib.utils.ServiceCompatibilityUtils;
...
public class DependencyContainerInternal implements DependencyContainer {
    ...
    private static final String SERVICE_NOT_FOUND_FORMAT = "Component \"%s\" was not found.";
    ...
    public void init(Collection<Class<?>> locatedClasses, Collection<ServiceDetails> servicesAndBeans,
        ...
        this.services = servicesAndBeans;
    ...
    public <T> T getNewInstance(Class<?> serviceType, String instanceName) {
        @SuppressLint({"NewApi", "LocalSuppress"}) final ServiceDetails serviceDetails = this.findServiceDetails(serviceType, instanceName);
    ...
    /**
     * Gets instances of all {@link Inject} annotated dependencies for a given service.
     *
     * @param serviceDetails - the given service.
     * @return array of instantiated dependencies.
     */
